...
<head>
	...
	<link rel="shortcut icon" href="../../../public/statics/favicon.ico">
...
<body>
	...
	<div class="content">
		<div class="poster">
			<img src="../../assets/images/match-poster.png" class="post-img" />
			<div class="poster-title">
				<div class="poster-title-team">
					<img src="../../assets/images/team1.png" width="40px" height="40px">
					<div>马刺(50)</div>
				</div>
				<div>VS</div>
				<div class="poster-title-team">
					<img src="../../assets/images/team2.png" width="40px" height="40px">
					<div>火箭(52)</div>
				</div>
			</div>
		</div>
			...
			<div id="match-result">
				<div class="frame">
					...
					<div class="frame-item">
						...
						<div class="frame-item-author">
							<img src="../../assets/images/team1.png" width="20px" height="20px" /> 马刺
						</div>
						<p>08:44 暂停 常规暂停</p>
				...
				<div class="frame">
					...
					<div class="frame-item">
						<span class="frame-dot"></span>
						<div class="frame-item-author">
							<img src="../../assets/images/team2.png" width="20px" height="20px" /> 火箭
						</div>
						<p>比赛如火如荼~~~</p>
						<p>
			...
			<div id="match-data" class="hidden match-data">
				...
				<div class="match-report">
					...
					<div class="match-report-row">
						<span><img src="../../assets/images/team1.png" width="30px" height="30px" /></span>
						<span>20</span>
						<span>-</span>
						<span>-</span>
						<span>20</span>
					...
					<div class="match-report-row">
						<span>
							<img src="../../assets/images/team2.png" width="30px" height="30px" />
						</span>
						<span>15</span>
						<span>-</span>
						<span>-</span>
				...
				<div class="mvp">
					...
					<div>
						<div class="mvp-player">
							<img src="../../assets/images/pa.png" width="50px;" height="40px" />
						...
						<div class="mvp-player">
							...
							<img src="../../assets/images/ha.png" width="50px;" height="40px" />
						</div>
					</div>
					<div>
						<div class="mvp-player">
						...
						<div class="mvp-player">
							...
							<img src="../../assets/images/bao.png" width="50px;" height="40px" />
						</div>
					</div>
				</div>
			</div>
